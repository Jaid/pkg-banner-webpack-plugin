...
```bash
npm install --save-dev pkg-banner-webpack-plugin@^1.1.0
```
...
```bash
yarn add --dev pkg-banner-webpack-plugin@^1.1.0
```
...
```bash
npm install --save-dev @jaid/pkg-banner-webpack-plugin@^1.1.0
```
